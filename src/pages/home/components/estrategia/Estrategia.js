...
export class Estrategia {
    ...
    updateActionStyle(decisao) {
        ...
        switch (decisao?.toUpperCase()) {
            case 'BUY':
            case 'COMPRAR':
                parentDiv.style.background = 'linear-gradient(135deg, #4caf50, #66bb6a)';
                break;
            case 'SELL':
            case 'VENDER':
                parentDiv.style.background = 'linear-gradient(135deg, #ff4757, #ff6b6b)';
                break;
            case 'HOLD':
            case 'MANTER':
            default:
                parentDiv.style.background = 'linear-gradient(135deg, #ff8c42, #ff6b35)';
                break;
        }
    }
